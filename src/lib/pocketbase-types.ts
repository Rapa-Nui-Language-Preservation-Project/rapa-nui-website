...
export type AgroecologyPlantOriginOptions =
	(typeof AgroecologyPlantOriginOptions)[keyof typeof AgroecologyPlantOriginOptions];
...
export type LanguageBooksSectionOptions =
	(typeof LanguageBooksSectionOptions)[keyof typeof LanguageBooksSectionOptions];
...
export type AuthorsResponse<Texpand = unknown> = Required<AuthorsRecord> &
	BaseSystemFields<Texpand>;
export type LanguageBooksResponse<Texpand = unknown> = Required<LanguageBooksRecord> &
	BaseSystemFields<Texpand>;
