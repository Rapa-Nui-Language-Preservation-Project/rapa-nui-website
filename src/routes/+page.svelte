...
<div class="min-h-screen w-screen bg-cover bg-center bg-no-repeat" style="background-image: url('http://127.0.0.1:8090/api/files/ia77ailu3ghoodv/oi61y31b9ukmkwa/pexels_magda_ehlers_pexels_636353_olu9cogeg5.jpg');">
